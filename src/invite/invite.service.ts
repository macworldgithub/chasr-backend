...
export class InviteService {
  ...
  async createInvite(
    ...
    if (inviteeEmail) {
      this.logger.log(
        `Sending invite email to ${inviteeEmail} for provider ${provider}`,
      );
  ...
  async redeemInvite(
    ...
    this.logger.log(
      `Notifying admin ${invite.createdByUserId} that invite ${token} was redeemed`,
    );
